...
==================================================================================
Script Purpose: 
    This stored procedure performs ETL (Extract, Transform, Load) process to insert data into the 'silver' schema tables from 'bronze' schemsas.
    It performs the following functions:
    - Truncates existing tables bebfore loading data
    - Inserts Cleaned & Transformed data from bronze tables into silver tables
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            prd_nm,
            ISNULL(prd_cost, 0), -- handle null values
            CASE UPPER(TRIM(prd_line))
                ...
                WHEN 'T' THEN 'Touring'
                ELSE 'n/a'
            END AS prd_line, -- data normalisation, provide descriptive values
